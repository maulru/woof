...
/*
    ...
    public void falar() {
        mTTS.speak("Calendario Geral", TextToSpeech.QUEUE_FLUSH, null);
    ...
    private void parseJSON() {
        String url = "http://"+server+"/woof/calendario.php?h="+usuario.getId()+"&usuario_rede="+usuario.getMedia();
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Log.i("ResponseJSON","response:"+response);
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String dia = hit.getString("dia");
                                String horario = hit.getString("horario");
                                String nome = hit.getString("pet");
                                String tipo = hit.getString("tipo");

                                myCalendar.addEvent(dia, horario, tipo+ " " +nome);
                            }
