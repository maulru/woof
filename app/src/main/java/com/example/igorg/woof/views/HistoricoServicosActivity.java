...
public class HistoricoServicosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetHttpResponse(HistoricoServicosActivity.this).execute();
        ...
        HistoricoListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(HistoricoServicosActivity.this,HistoricoIndividualActivity.class);
