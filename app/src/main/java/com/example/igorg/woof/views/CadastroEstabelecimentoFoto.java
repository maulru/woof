...
public class CadastroEstabelecimentoFoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cadastreseupet2);
        ...
        ServerUploadPath = "http://"+servidor+"/woof/upload_photo.php?h="+estabelecimentoId;
    ...
    public void UploadImageToServer() {
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(CadastroEstabelecimentoFoto.this, "Enviando dados", "Por favor aguarde", false, false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(CadastroEstabelecimentoFoto.this, string1, Toast.LENGTH_LONG).show();

                finish();
                Intent intent = new Intent (CadastroEstabelecimentoFoto.this,HomeUserActivity.class);
