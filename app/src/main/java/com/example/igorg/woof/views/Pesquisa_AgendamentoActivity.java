...
public class Pesquisa_AgendamentoActivity extends Activity {
    ...
    EditText dia;
    String Tipo,Horario,Id,DIAHOLDER,server;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        horarios_excluirAdapter = new Horarios_ExcluirAdapter(Pesquisa_AgendamentoActivity.this, R.layout.horarios_row,
                horariosArray);
        ...
        horarioList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                Toast.makeText(Pesquisa_AgendamentoActivity.this, "List View Clicked:" + position, Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void teste_dia(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://"+server+"/woof/pesquisa_agendamento.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String getObject = jObj.getString("agendamento");
