...
public class AgendarBanho_Mapa extends AppCompatActivity  implements DatePickerDialog.OnDateSetListener{
    ...
    String php_pet = "http://192.168.43.46/woof/pet.php";
    String php_horario = "http://192.168.43.46/woof/horario.php";
    String php_horario_filtro= "http://192.168.43.46/woof/horario.php";
    String[] data_pet;
    String[] data_horario;
    ...
    TextView TELEFONE,tipo_servico,estab_nome;
    EditText NOME;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agendar_mapa);
        ...
        tipo_servico = (TextView) findViewById(R.id.TipoServico);

        StrictMode.setThreadPolicy((new StrictMode.ThreadPolicy.Builder().permitNetwork().build()));

        server = Servidor.getIp();
        estab_nome=(TextView) findViewById(R.id.txt_nome_estab_mapa);
        estab_nome.setText(getIntent().getStringExtra("nome"));
       ...
       // teste_dia();
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Tipo", tipo_servico.getText().toString());
    ...
    public void horario(){
        Log.i("ID_Estabelecimento","id:"+estabelecimentoId);
    ...
    private void array(JSONArray j) {
        ...
        spinner.setAdapter(new ArrayAdapter<String>(AgendarBanho_Mapa.this, android.R.layout.simple_spinner_dropdown_item, arrayList));
    }
...
////////////////////////////////////////////////////
    ...
    private void array1(JSONArray j) {
        ...
        spinner_pet.setAdapter(new ArrayAdapter<String>(AgendarBanho_Mapa.this, android.R.layout.simple_spinner_dropdown_item, arrayList1));
    }
    ...
    public void teste_dia(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://"+server+"/woof/mapa_nome_dois.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Log.i("ID_Teste","ID:"+jObj.getString("ID_Estabelecimento"));
                         /*   for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                estabelecimentoId = Integer.valueOf(id);
                                id_estabelecimento.setText(id);
                                endereco_txt.setText(endereco1);

                                Log.i("iD_ESTAB","id:"+id);

                                Log.i("iD_ESTAB","id:"+id_estabelecimento);

                            }
*/
                        } catch (JSONException e) {
                           Log.e("ErroJSON:","Erro:"+e);
                        }
                    }
                },
    ...
    public void JSON_WEB_CALL(){
        ...
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,"http://"+server+"woof/mapa_nome_tres?nome="+NomeHolder, null,
        ...
        requestQueue = Volley.newRequestQueue(AgendarBanho_Mapa.this);
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONObject object) {
        ...
        int id = 0;
        String nome,raca,tipo,estab_endereco;
        ...
        try {
            ...
            nome1 = json.getString("Nome");
            tipo = json.getString("Tipo");
            estab_endereco = json.getString("Endereco");

            id_estabelecimento.setText(id);

            endereco_txt.setText(estab_endereco);
