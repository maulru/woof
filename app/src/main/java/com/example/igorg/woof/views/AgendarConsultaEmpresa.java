...
public class AgendarConsultaEmpresa extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    String usuario_email,url_busca_email,id_usuario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agendar_consulta_empresa);
        ...
        Email_usuario = (EditText) findViewById(R.id.email_usuario_empresa);
        //ENDERECO = (TextView)findViewById(R.id.Endereco);

        spinner_pet = findViewById(R.id.spinnerPet_empresa);
        spinner = (Spinner) findViewById(R.id.spinnerHorario_empresa);
        horario_txt = (TextView) findViewById(R.id.horario_txt_empresa);
        id_txt = (TextView) findViewById(R.id.id_horario_empresa);
        id_pet = (TextView) findViewById(R.id.id_pet_empresa);
        id_estabelecimento = (TextView) findViewById(R.id.id_estabelecimento_empresa);
        pet = (TextView) findViewById(R.id.pet_txt_empresa);
        ...
        dateText = findViewById(R.id.date_text_empresa);

        findViewById(R.id.show_dialog_empresa).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        tipo = (TextView) findViewById(R.id.TipoServico_empresa);

        observacao = (EditText) findViewById(R.id.observacao_empresa);
        data = (TextView) findViewById(R.id.date_text_empresa);
        horario = (TextView) findViewById(R.id.horario_txt_empresa);
        id_horario = (TextView) findViewById(R.id.id_horario_empresa);


        enviar = (Button) findViewById(R.id.Enviar_empresa);
        ...
        checar = (Button) findViewById(R.id.butt_checar_email_empresa);
    ...
    private void verificaEmail() {
        ...
        requestQueue = Volley.newRequestQueue(AgendarConsultaEmpresa.this);
    ...
    private void array(JSONArray j) {
        ...
        spinner.setAdapter(new ArrayAdapter<String>(AgendarConsultaEmpresa.this, android.R.layout.simple_spinner_dropdown_item, arrayList));
    }
...
////////////////////////////////////////////////////
    ...
    private void array1(JSONArray j) {
        ...
        spinner_pet.setAdapter(new ArrayAdapter<String>(AgendarConsultaEmpresa.this, android.R.layout.simple_spinner_dropdown_item, arrayList1));
    }
