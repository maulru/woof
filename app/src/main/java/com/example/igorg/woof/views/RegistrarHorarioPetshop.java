...
public class RegistrarHorarioPetshop extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registrar_horario_petshop);

        tipo_servico = "Banho";
        server = Servidor.getIp();

        registrar = (Button) findViewById(R.id.registrar_horario_petshop);
        tvw=(TextView)findViewById(R.id.textView1_petshop);
        dataEdit = (EditText) findViewById(R.id.editHorarioData_petshop);
        dataEscolhe = (Button) findViewById(R.id.date_dia_petshop);

        hora = (EditText) findViewById(R.id.editHoraRegistra_petshop);
        minuto = (EditText) findViewById(R.id.editMinutoRegistra_petshop);

        tipo = (Spinner) findViewById(R.id.spinner_tipo_petshop);
        List<String> tipos = new ArrayList<>(Arrays.asList("Banho","Tosa"));
        ...
        final EditText campo_data = (EditText) findViewById(R.id.editHorarioData_petshop);
        campo_data.addTextChangedListener(Mask.insert("##/##/####", campo_data));

        final EditText campo_hora = (EditText) findViewById(R.id.editHoraRegistra_petshop);
        campo_hora.addTextChangedListener(Mask.insert("##", campo_hora));

        final EditText campo_minuto = (EditText) findViewById(R.id.editMinutoRegistra_petshop);
        campo_minuto.addTextChangedListener(Mask.insert("##", campo_minuto));

        dateText = findViewById(R.id.date_text_petshop);

        findViewById(R.id.date_dia_petshop).setOnClickListener(new View.OnClickListener() {
            @Override
