...
public class UpdateHistoricoActivity extends AppCompatActivity {
    ...
    public void StudentRecordUpdate(final String ID, final String Obs){
        ...
        class StudentRecordUpdateClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(UpdateHistoricoActivity.this,"Carregando",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(UpdateHistoricoActivity.this,httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
