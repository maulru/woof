...
public class AgendarConsulta_Mapa extends AppCompatActivity  implements DatePickerDialog.OnDateSetListener{
    ...
    String nome1,telefone,id,endereco1,tipo_estab;
    String server;
    ArrayAdapter<String> adapter;
    Spinner spinner_horario,spinner_servico;
    Spinner spinner_pet;
    ...
    TextView data,tipo, horario,id_horario,pet,escolha_servico,nome_estab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nome_estab = findViewById(R.id.txt_nome_estab_mapa);
        ...
        tipo_servico = (TextView) findViewById(R.id.txt_tipo);
        ...
        tipo_servico = findViewById(R.id.TipoServico);
    ...
    private void array(JSONArray j) {
        ...
        spinner.setAdapter(new ArrayAdapter<String>(AgendarConsulta_Mapa.this, android.R.layout.simple_spinner_dropdown_item, arrayList));
    }
...
////////////////////////////////////////////////////
    ...
    private void array1(JSONArray j) {
        ...
        spinner_pet.setAdapter(new ArrayAdapter<String>(AgendarConsulta_Mapa.this, android.R.layout.simple_spinner_dropdown_item, arrayList1));
    }
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                              ...
                              //  habilitaCampo();
                                ...
                                tipo_estab = jsonObject.getString("Tipo");
                                tipo.setText(tipo_estab);

                                nome_estab.setText(tipo_estab);
                                estabelecimentoId = Integer.parseInt(id);
...
/*
    public void habilitaCampo(){
        if(tipo_estab.equals("Petshop")){
            nome_estab.setText("Petshop");



        }else{
            nome_estab.setText("Clinica Veterinaria");
...
*/
    ...
    public void JSON_WEB_CALL(){
        ...
        requestQueue = Volley.newRequestQueue(AgendarConsulta_Mapa.this);
